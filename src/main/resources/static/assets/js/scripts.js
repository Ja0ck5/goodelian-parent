...
jQuery(document).ready(function() {
    ...
    */
    $('.page-title').backstretch("http://pa7v38t3f.bkt.clouddn.com/background_1.jpg");
    $('.counters-container').backstretch("http://pa7v38t3f.bkt.clouddn.com/background_1.jpg");
    $('.our-motto-container').backstretch("http://pa7v38t3f.bkt.clouddn.com/background_1.jpg");
    $('.call-to-action-container').backstretch("http://pa7v38t3f.bkt.clouddn.com/background_1.jpg");
